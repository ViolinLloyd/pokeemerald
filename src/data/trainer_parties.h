...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = MOVE_INGRAIN, MOVE_NEEDLE_ARM, MOVE_PIN_MISSILE, MOVE_SANDSTORM
    },
    {
    .iv = 100,
    .lvl = 30,
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SANDSLASH,
    .moves = MOVE_DIG, MOVE_SLASH, MOVE_SANDSTORM, MOVE_POISON_STING
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_CACNEA,
    .moves = MOVE_POISON_STING, MOVE_ABSORB, MOVE_INGRAIN, MOVE_FAINT_ATTACK
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 45,
    .species = SPECIES_MAGNETON,
    .moves = MOVE_DOUBLE_EDGE, MOVE_THUNDER_WAVE, MOVE_TRI_ATTACK, MOVE_THUNDERBOLT
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_EXPLOUD,
    .moves = MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_SMELLING_SALT, MOVE_HYPER_VOICE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_TOXIC, MOVE_REST
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .moves = MOVE_CONFUSION, MOVE_AERIAL_ACE, MOVE_DISABLE, MOVE_SURF
    },
    {
    .iv = 100,
    .lvl = 30,
    ...
    .moves = MOVE_TOXIC, MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vito[] = {
    {
    .iv = 100,
    .lvl = 44,
    .species = SPECIES_DODRIO,
    .moves = MOVE_TRI_ATTACK, MOVE_DRILL_PECK, MOVE_AERIAL_ACE, MOVE_STEEL_WING,
    },
    {
    .iv = 100,
    .lvl = 45,
    .species = SPECIES_CLAYDOL,
    .moves = MOVE_SANDSTORM, MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_ANCIENT_POWER,
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_SANDSLASH,
    .moves = MOVE_TOXIC, MOVE_SLASH, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE,
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_CACTURNE,
    .moves = MOVE_SANDSTORM, MOVE_NEEDLE_ARM, MOVE_GIGA_DRAIN, MOVE_SPIKES,
    },
    {
    .iv = 100,
    .lvl = 45,
    .species = SPECIES_WHISCASH,
    .moves = MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_FISSURE, MOVE_ICE_BEAM,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_REST
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .moves = MOVE_THUNDERBOLT, MOVE_EXPLOSION, MOVE_SWIFT, MOVE_MIRROR_COAT
    },
    {
    .iv = 100,
    .lvl = 30,
    .species = SPECIES_DONPHAN,
    .moves = MOVE_ROLLOUT, MOVE_EARTHQUAKE, MOVE_FISSURE, MOVE_BODY_SLAM
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .moves = MOVE_IRON_DEFENSE, MOVE_WHIRLPOOL, MOVE_RAIN_DANCE, MOVE_SURF
    },
    {
    .iv = 100,
    .lvl = 41,
    .species = SPECIES_HUNTAIL,
    .moves = MOVE_CRUNCH, MOVE_DIVE, MOVE_CONFUSE_RAY, MOVE_TOXIC
    },
    {
    .iv = 100,
    .lvl = 41,
    .species = SPECIES_GOREBYSS,
    .moves = MOVE_PSYCHIC, MOVE_SURF, MOVE_HYDRO_PUMP, MOVE_BLIZZARD
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jace[] = {
    {
    .iv = 100,
    .lvl = 27,
    .species = SPECIES_SOLROCK,
    .moves = MOVE_FLAMETHROWER, MOVE_CONFUSION, MOVE_FIRE_SPIN, MOVE_ROCK_SLIDE
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Drew[] = {
    ...
    .lvl = 24,
    .species = SPECIES_CACNEA,
    .moves = MOVE_INGRAIN, MOVE_SAND_ATTACK, MOVE_LEECH_SEED, MOVE_ABSORB
    },
    {
    .iv = 0,
    .lvl = 24,
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 23,
    .species = SPECIES_SANDSLASH,
    .moves = MOVE_POISON_STING, MOVE_SAND_ATTACK, MOVE_SLASH, MOVE_DIG
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_NUMEL,
    .moves = MOVE_MAGNITUDE, MOVE_EMBER, MOVE_STOMP, MOVE_AMNESIA
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jaclyn[] = {
    ...
    .moves = MOVE_CONFUSION, MOVE_DOUBLE_TEAM, MOVE_NONE, MOVE_NONE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = MOVE_ROAR, MOVE_DIG, MOVE_POISON_FANG, MOVE_CRUNCH
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = MOVE_GIGA_DRAIN, MOVE_ROCK_TOMB, MOVE_SWAGGER, MOVE_EXTRASENSORY
    },
    {
    .iv = 250,
    .lvl = 46,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = MOVE_POISON_FANG, MOVE_AIR_CUTTER, MOVE_FAINT_ATTACK, MOVE_CONFUSE_RAY
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE, MOVE_DIG
    },
    {
    .iv = 250,
    .lvl = 47,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_NONE,
    .moves = MOVE_POISON_FANG, MOVE_CRUNCH, MOVE_GIGA_DRAIN, MOVE_EARTHQUAKE
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_ABSOL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_AERIAL_ACE, MOVE_FAINT_ATTACK, MOVE_SWORDS_DANCE, MOVE_SLASH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_BALL, MOVE_ICY_WIND, MOVE_WILL_O_WISP, MOVE_THUNDERBOLT
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_CHIMECHO,
    .heldItem = ITEM_NONE,
    .moves = MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_DREAM_EATER, MOVE_DOUBLE_TEAM
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_NONE,
    .moves = MOVE_CONFUSE_RAY, MOVE_FLAMETHROWER, MOVE_IRON_TAIL, MOVE_FAINT_ATTACK
    },
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = MOVE_SHADOW_BALL, MOVE_FAINT_ATTACK, MOVE_IMPRISON, MOVE_PROTECT
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_SHEDINJA,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_TOXIC, MOVE_DOUBLE_TEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .species = SPECIES_GLALIE,
    .heldItem = ITEM_NONE,
    .moves = MOVE_SHADOW_BALL, MOVE_EARTHQUAKE, MOVE_HAIL, MOVE_BLIZZARD
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SURF, MOVE_SHEER_COLD, MOVE_ICE_BEAM, MOVE_SING
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_LOVELY_KISS, MOVE_ICE_BEAM, MOVE_ATTRACT, MOVE_DREAM_EATER
    },
    {
    .iv = 250,
    .lvl = 51,
    ...
    .moves = MOVE_ICE_BEAM, MOVE_SHEER_COLD, MOVE_REST, MOVE_WATER_PULSE
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_BLIZZARD, MOVE_EARTHQUAKE, MOVE_TAKE_DOWN, MOVE_ANCIENT_POWER
    },
    {
    .iv = 255,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_HYDRO_PUMP, MOVE_HYPER_BEAM, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SMOKESCREEN, MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_ICE_BEAM
    },
    {
    .iv = 250,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SCRATCH, MOVE_HARDEN, MOVE_WATER_GUN, MOVE_ROCK_TOMB
    },
    {
    .iv = 150,
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_INGRAIN, MOVE_ACID, MOVE_ABSORB, MOVE_ROCK_TOMB
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_NONE,
    .moves = MOVE_FURY_ATTACK, MOVE_KARATE_CHOP, MOVE_COUNTER, MOVE_BULK_UP
    },
    {
    .iv = 120,
    .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_SURF
    },
    {
    .iv = 220,
    .lvl = 26,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_SUPERSONIC, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE, MOVE_DIVE
    },
    {
    .iv = 250,
    .lvl = 27,
...
static const struct TrainerMonItemCustomMovesShiny sParty_Winona1[] = {
    {
    .iv = 255,
    .lvl = 30,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_SHARP_BEAK,
    .moves = {MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_ENDEAVOR, MOVE_QUICK_ATTACK},
    .shiny = SHINY_STATUS_YES
    },
    {
    .iv = 210,
    .lvl = 29,
    .species = SPECIES_XATU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_CONFUSE_RAY, MOVE_WISH, MOVE_AERIAL_ACE},
    .shiny = SHINY_STATUS_NO
    },
    {
    .iv = 210,
    .lvl = 30,
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_REST, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE},
    .shiny = SHINY_STATUS_NO
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_LUSTER_PURGE, MOVE_DRAGON_BREATH, MOVE_FLY, MOVE_EARTHQUAKE
    },
    {
    .iv = 250,
    .lvl = 40,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_MIST_BALL, MOVE_SAFEGUARD, MOVE_DRAGON_BREATH, MOVE_RECOVER
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = MOVE_WATER_PULSE, MOVE_ICE_PUNCH, MOVE_GIGA_DRAIN, MOVE_RAIN_DANCE
    },
    {
    .iv = 200,
    .lvl = 41,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = MOVE_WATER_PULSE, MOVE_CRABHAMMER, MOVE_CRUNCH, MOVE_GUILLOTINE
    },
    {
    .iv = 200,
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_DIVE, MOVE_ANCIENT_POWER, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE
    },
    {
    .iv = 200,
    .lvl = 45,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = MOVE_REST, MOVE_SNORE, MOVE_ICE_BEAM, MOVE_WATER_PULSE
    },
    {
    .iv = 200,
    .lvl = 45,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_ICE_PUNCH, MOVE_WATERFALL, MOVE_PROTECT, MOVE_EARTHQUAKE
    },
    {
    .iv = 250,
    .lvl = 46,
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .lvl = 35,
    .species = SPECIES_SLAKING,
    .moves = MOVE_BODY_SLAM, MOVE_YAWN, MOVE_SLACK_OFF, MOVE_FAINT_ATTACK
    },
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_VIGOROTH,
    .moves = MOVE_SLASH, MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_DOUBLE_EDGE
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .lvl = 20,
    .species = SPECIES_GYARADOS,
    .moves = MOVE_BITE, MOVE_SURF, MOVE_DRAGON_RAGE, MOVE_THRASH
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .lvl = 24,
    .species = SPECIES_LINOONE,
    .moves = MOVE_HEADBUTT, MOVE_FURY_SWIPES, MOVE_MUD_SPORT, MOVE_THUNDERBOLT
    },
    {
    .iv = 150,
    .lvl = 25,
    .species = SPECIES_ELECTRIKE,
    .moves = MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_SPARK, MOVE_HOWL
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = MOVE_EARTHQUAKE, MOVE_SURF, MOVE_BLIZZARD, MOVE_HYPER_BEAM
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_RELICANTH,
    .heldItem = ITEM_NONE,
    .moves = MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_DIVE
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMonNoItemCustomMoves sParty_Camden[] = {
    ...
    .lvl = 37,
    .species = SPECIES_LINOONE,
    .moves = MOVE_SURF, MOVE_SLASH, MOVE_REST, MOVE_BELLY_DRUM
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 22,
    .species = SPECIES_GEODUDE,
    .moves = MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_ROCK_TOMB, MOVE_MAGNITUDE
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_SKARMORY,
    .moves = MOVE_STEEL_WING, MOVE_AIR_CUTTER, MOVE_SWIFT, MOVE_SPIKES
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    .lvl = 35,
    .species = SPECIES_WEEZING,
    .moves = MOVE_TOXIC, MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wally1[] = {
    ...
    .lvl = 45,
    .species = SPECIES_AGGRON,
    .moves = MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL, MOVE_ICE_PUNCH, MOVE_ROAR
    },
    {
    .iv = 150,
    .lvl = 45,
    ...
    .lvl = 47,
    .species = SPECIES_KINGDRA,
    .moves = MOVE_SURF, MOVE_HYDRO_PUMP, MOVE_TWISTER, MOVE_ICE_BEAM
    },
    {
    .iv = 250,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_ROAR
    },
    {
    .iv = 100,
    .lvl = 36,
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_NONE,
    .moves = MOVE_EARTHQUAKE, MOVE_TAKE_DOWN, MOVE_ROCK_BLAST, MOVE_THUNDER
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 22,
    .species = SPECIES_MACHOP,
    .moves = MOVE_FOCUS_ENERGY, MOVE_KARATE_CHOP, MOVE_SEISMIC_TOSS, MOVE_THUNDER_PUNCH
    },
    {
    .iv = 100,
    .lvl = 24,
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 26,
    .species = SPECIES_MEDITITE,
    .moves = MOVE_HI_JUMP_KICK, MOVE_THUNDER_PUNCH, MOVE_CONFUSION, MOVE_FIRE_PUNCH
    },
    {
    .iv = 100,
    .lvl = 26,
    .species = SPECIES_MACHOP,
    .moves = MOVE_THUNDER_PUNCH, MOVE_KARATE_CHOP, MOVE_SEISMIC_TOSS, MOVE_FIRE_PUNCH
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 29,
    .species = SPECIES_SEVIPER,
    .moves = MOVE_GLARE, MOVE_POISON_FANG, MOVE_POISON_TAIL, MOVE_CRUNCH
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 35,
    .species = SPECIES_TROPIUS,
    .moves = MOVE_SYNTHESIS, MOVE_SOLAR_BEAM, MOVE_MAGICAL_LEAF, MOVE_AERIAL_ACE
    },
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_CAMERUPT,
    .moves = MOVE_FLAMETHROWER, MOVE_TAKE_DOWN, MOVE_SUNNY_DAY, MOVE_EARTHQUAKE
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 23,
    .species = SPECIES_LOMBRE,
    .moves = MOVE_ABSORB, MOVE_NATURE_POWER, MOVE_FURY_SWIPES, MOVE_SURF
    },
    {
    .iv = 0,
    .lvl = 25,
    .species = SPECIES_NUZLEAF,
    .moves = MOVE_TORMENT, MOVE_NATURE_POWER, MOVE_FAINT_ATTACK, MOVE_BULLET_SEED
    }
};
...
static const struct TrainerMonItemCustomMovesShiny sParty_Winona2[] = {
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_SWELLOW,
...
static const struct TrainerMonItemCustomMovesShiny sParty_Winona3[] = {
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMovesShiny sParty_Winona4[] = {
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMovesShiny sParty_Winona5[] = {
    {
    .iv = 255,
    .lvl = 53,
    .species = SPECIES_NOCTOWL,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_NINJASK,
    .heldItem = ITEM_NONE,
    .moves = MOVE_FURY_CUTTER, MOVE_FURY_SWIPES, MOVE_DOUBLE_TEAM, MOVE_SCREECH
    },
    {
    .iv = 100,
    .lvl = 22,
    .species = SPECIES_SHEDINJA,
    .heldItem = ITEM_NONE,
    .moves = MOVE_FURY_SWIPES, MOVE_CONFUSE_RAY, MOVE_SHADOW_BALL, MOVE_LEECH_LIFE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = MOVE_HYPER_BEAM, MOVE_PSYCHIC, MOVE_ANCIENT_POWER, MOVE_EARTHQUAKE
    },
    {
    .iv = 255,
    .lvl = 77,
    ...
    .heldItem = ITEM_NONE,
    .moves = MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_INGRAIN, MOVE_TOXIC
    },
    {
    .iv = 255,
    .lvl = 78,
